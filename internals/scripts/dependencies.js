...
/**
 * Use node_modules/react-boilerplate-dlls by default because
 * it won't be version controlled and babel wont try to parse it.
 */
mkdir('-p', outputPath);
...
/**
 * Create a manifest so npm install doesn't send a warning
 */
